...
rm -rf exp mfcc data/train/spk2utt data/train/utt2dur data/train/utt2num_frames data/train/frame_shift data/train/cmvn.scp data/train/feats.scp data/train/split1 data/test/spk2utt data/test/utt2dur data/test/utt2num_frames data/test/frame_shift data/test/cmvn.scp data/test/feats.scp data/test/split1 data/local/lang data/lang data/local/tmp data/local/dict/lexiconp.txt
