...
steps/make_mfcc.sh --nj $nj --cmd "$train_cmd" data/train exp/make_mfcc/train $mfccdir || exit 1
...
./prepare_LG.sh lexicon.txt $local/tmp/lm.arpa phones.txt data/local/dict data/lang
